...
class OrderItemControllerTest {
    ...
    void getAllOrderItems_shouldReturnOk() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/order-items").contentType(MediaType.APPLICATION_JSON))
    ...
    void getItemsByOrderId_shouldReturnOk() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/order-items/order/{orderId}", orderId)
    ...
    void getItemsByProductId_shouldReturnOk() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/order-items/product/{productId}", productId)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.size()").value(1))
    ...
    void deleteOrderItem_shouldReturnNoContent() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/order-items/{id}", itemId)
                .contentType(MediaType.APPLICATION_JSON))
